...
export const de = {
  ...
  dashboard: {
    ...
    analysis: {
      ...
      subtitle: 'KI-Bewertung deiner Online-Präsenz',
      scoreOutOf: '/100',
      scoreLabel: 'Gesamtbewertung',
      analyzedAt: (date: string) => `Analysiert am ${date}`,
      loading: 'Deine Website wird analysiert …',
      summaryLabel: 'Zusammenfassung',
      brandToneLabel: 'Markenton',
      servicesLabel: 'Angebote',
      seoLabel: 'SEO-Einschätzung',
      strengthsLabel: 'Stärken',
      weaknessesLabel: 'Schwächen & Probleme',
      targetAudienceLabel: 'Zielgruppe',
      growthLabel: 'Wachstumspotenzial',
      strengthsCount: (n: number) =>
        n === 1 ? '1 Stärke erkannt' : `${n} Stärken erkannt`,
      weaknessesCount: (n: number) =>
        n === 1 ? '1 Schwäche erkannt' : `${n} Schwächen erkannt`,
      bands: {
        Kritisch: 'Kritisch',
      ...
      locked: {
        ...
        description:
          'Mit einem aktiven Abo siehst du alle Stärken, Schwächen, die SEO-Einschätzung und dein konkretes Wachstumspotenzial.',
      ...
      empty: {
        ...
        description:
          'Hinterlege im Unternehmensprofil deine Website-Adresse, um eine KI-Analyse zu erhalten.',
        cta: 'Website hinterlegen',
      },
      error: 'Analyse konnte nicht geladen werden.',
    },
    trends: {
      title: 'Trends für dich',
      subtitle: 'Passend zu deiner Branche',
      loading: 'Trends werden geladen …',
      fitBadge: 'Passt zu dir',
      empty: {
        title: 'Keine passenden Trends',
        description:
          'Ergänze deine Branche im Unternehmensprofil, damit wir passende Trends für dich finden.',
        cta: 'Branche ergänzen',
      },
      error: 'Trends konnten nicht geladen werden.',
    },
    plan: {
      title: 'Dein Wochenplan',
      subtitle: 'KI-Vorschläge für diese Woche',
      loading: 'Plan wird erstellt …',
      createCta: 'Inhalt erstellen',
      ...
      locked: {
        title: 'Wochenplanung freischalten',
        description:
          'Mit einem aktiven Abo erhältst du jede Woche einen fertigen Content-Plan – Tag, Kategorie und Plattform inklusive.',
        cta: 'Jetzt freischalten',
        badge: 'Premium',
      },
    },
    today: {
      greeting: 'Was heute ansteht',
      loading: 'Wir stellen deine Empfehlung zusammen …',
      planLine: (category: string, platform: string) =>
        `Erstelle heute einen ${category}-Beitrag für ${platform}.`,
      trendLine: (title: string) =>
        `Aktueller Trend: „${title}“ – ideal für ein kurzes Reel.`,
      planAndTrend: (category: string, platform: string, title: string) =>
        `Erstelle heute einen ${category}-Beitrag für ${platform} und greif den Trend „${title}“ auf.`,
      fallback: 'Leg los und erstelle deinen ersten Beitrag für diese Woche.',
    },
    content: {
      title: 'Inhalt erstellen',
      subtitle: 'Wähle ein Format und leg im KI-Studio los',
  ...
  admin: {
    ...
    nav: {
      ...
      websiteAnalyze: 'Website-Analyse',
      usage: 'Nutzung',
      settings: 'Plattform',
    ...
    websiteAnalyze: {
      title: 'Website-Analyse',
      description: 'Lead-Research und Wettbewerbsanalyse per klicklocal-webanalyze Skill',
      heroTitle: 'Klicklocal analysiert Websites mit KI',
      heroSubtitle:
        'Gib eine URL ein — der Agent SDK Skill liefert Score, SEO-Bewertung, CRM-Kontaktdaten und Gesprächsaufhänger.',
      urlPlaceholder: 'https://beispiel-gastro.de',
      analyze: 'Analysieren',
      analyzing: 'Analysiere…',
      longRunningHint:
        'Die Analyse läuft im Hintergrund und kann mehrere Minuten dauern.',
      statusLabel: 'Status',
      statusQueued: 'In Warteschlange',
      statusProcessing: 'Wird analysiert',
      queueHint:
        'Stelle sicher, dass ein Queue-Worker läuft: php artisan queue:work',
      partialHint:
        'Teilergebnis — die Analyse wurde vorzeitig beendet (Timeout oder Budget).',
      ...
      report: {
        ...
        growthForecast: 'Wachstumsprognose',
        revenuePotential: 'Umsatzpotenzial',
        assumptions: 'Annahmen',
        categoryScores: 'Kategorie-Scores',
        strengths: 'Stärken',
        weaknesses: 'Schwächen & Probleme',
        improvements: 'Verbesserungspotenziale',
        talkingPoints: 'Gesprächsaufhänger',
        crm: 'Kontaktdaten (CRM)',
        marketPotential: 'Lokales Marktpotenzial',
        seoAssessment: 'SEO-Bewertung',
        socialAudit: 'Social-Media-Audit',
        googleVisibility: 'Google-Sichtbarkeit & Wettbewerb',
        klicklocalPitch: 'So hilft Klicklocal',
        internalNotes: 'Interne Notizen',
        internalNotesHint: 'Nicht für den Kunden',
        cached: 'Gecacht – Analyse aus dem Zwischenspeicher (bis zu 7 Tage alt)',
        downloadPdf: 'Als PDF herunterladen',
        downloadInternalPdf: 'Internes PDF',
        internalPdfLabel: 'INTERN — Nicht für den Kunden',
        pdfExporting: 'PDF wird erstellt…',
        pdfFailed: 'PDF-Export fehlgeschlagen. Bitte erneut versuchen.',
      },
      history: {
        title: 'Frühere Analysen',
        description: 'Gespeicherte Lead-Reports — jederzeit erneut ansehen und als PDF exportieren.',
        date: 'Datum',
        website: 'Website',
        score: 'Score',
        status: 'Status',
        open: 'Anzeigen',
        empty: 'Noch keine Analysen gespeichert.',
        loadingRun: 'Bericht wird geladen…',
        partial: 'Teilergebnis',
        statusCompleted: 'Abgeschlossen',
        statusFailed: 'Fehlgeschlagen',
        statusProcessing: 'Läuft',
  ...
  socialAccounts: {
    ...
    facebook: {
      ...
      connectFailed: 'Verbindung fehlgeschlagen.',
      disconnectFailed: 'Trennen fehlgeschlagen.',
      successConnected: 'Facebook erfolgreich verbunden.',
      successDisconnected: 'Facebook-Verbindung getrennt.',
      errorOAuth: 'Facebook-Anmeldung abgebrochen oder fehlgeschlagen.',
    },
    tiktokPublish: {
      title: 'TikTok-Veröffentlichungsoptionen',
      privacyLabel: 'Wer kann dieses Video sehen?',
      privacy: {
      ...
      auditNotice:
        'Diese App ist noch nicht von TikTok für direkte Veröffentlichung freigegeben. Beiträge werden bis zur Freigabe privat (Nur ich) gepostet.',
      interaction: 'Interaktionen',
      allowComment: 'Kommentare erlauben',
      allowDuet: 'Duette erlauben',
      allowStitch: 'Stitch erlauben',
      disclosureTitle: 'Kommerzielle Inhalte offenlegen',
      disclosureHint:
        'Aktiviere dies, wenn dein Video für dich selbst oder eine andere Marke wirbt. TikTok schreibt diese Angabe vor.',
      yourBrand: 'Eigene Marke',
      yourBrandHint: 'Du bewirbst dein eigenes Unternehmen / deine eigene Marke.',
      brandedContent: 'Bezahlte Partnerschaft',
      brandedContentHint: 'Du bewirbst eine andere Marke (Werbeinhalt / Branded Content).',
      disclosureRequired:
        'Bitte wähle mindestens eine Option (Eigene Marke oder Bezahlte Partnerschaft).',
      brandedNotPrivate:
        'Bezahlte Partnerschaften können nicht als „Nur ich" gepostet werden. Bitte wähle eine öffentlichere Sichtbarkeit.',
      complianceNote:
        'Mit dem Veröffentlichen stimmst du den TikTok-Musiknutzungsbedingungen zu.',
      loading: 'Lade TikTok-Optionen …',
      loadError: 'TikTok-Optionen konnten nicht geladen werden.',
    },
  },
  calendar: {
    title: 'Kalender',
    description: 'Plane denselben Beitrag für mehrere Kanäle',
    ...
    dialog: {
      ...
      scheduledAt: 'Zeitpunkt',
      platforms: 'Kanäle',
      noPlatforms: 'Keine verbundenen Konten. Verbinde zuerst ein Social-Konto.',
      submit: 'Planen',
      submitting: 'Wird geplant …',
      success: 'Beitrag geplant.',
      errorNoPlatform: 'Wähle mindestens einen Kanal aus.',
      errorNoContent: 'Bitte gib einen Inhalt ein.',
      errorGeneric: 'Planen fehlgeschlagen.',
    },
    statusLabels: {
      scheduled: 'Geplant',
  ...
  comments: {
    ...
    statsEmpty: '–',
    statsCount: (count: number) => (count === 1 ? '1 Kommentar' : `${count} Kommentare`),
    suggest: 'KI-Antwort vorschlagen',
    suggesting: 'Vorschlag wird erstellt …',
    suggestionLabel: 'KI-Antwort',
    regenerate: 'Neu generieren',
    send: 'Antwort senden',
    sending: 'Wird gesendet …',
    replyPlaceholder: 'Deine Antwort …',
    repliedLabel: 'Beantwortet',
    repliedAt: (date: string) => `Beantwortet am ${date}`,
    manualNoReply:
      'Manuell erstellte Kommentare können nicht beantwortet werden — es gibt keinen verknüpften Plattform-Kommentar.',
    suggestError: 'Der Vorschlag konnte nicht erstellt werden. Bitte versuche es erneut.',
    replyError: 'Die Antwort konnte nicht gesendet werden. Bitte versuche es erneut.',
    replyEmpty: 'Bitte gib eine Antwort ein.',
  },
} as const;
